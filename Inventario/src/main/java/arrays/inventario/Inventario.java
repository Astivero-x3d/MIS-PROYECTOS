...
public class Inventario {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("Opcion 1. Agregar producto en la inventario");
            System.out.println("Opcion 2. Mostrar producto del inventario");
            System.out.println("Opcion 3. Actualizar producto del inventario");
            System.out.println("Opcion 4. Buscar producto del inventario");
            System.out.println("Opcion 5. Salir");
            System.out.print("\nEscribe cualquier opción: ");

            int opcion = sc.nextInt();
            sc.nextLine(); //Este codigo hace un salto de linea

            switch (opcion) {
                case 1: //Esta es la opcion de agregar producto en la inventario
                    System.out.println("\n");
                ...
                case 2: //Esta es la opcion 2 de mostrar producto del inventario
                ...
                case 3: //Esta es la opcion 3 para actualizar producto del inventario
                ...
                case 4: //Esta es la opcion de buscar el producto del inventario
